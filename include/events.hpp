...
namespace esp32m
{
  ...
  /**
   * @brief Base class for events. May be subclassed to add custom properties and logic to custom events
   */
  class Event
  {
  public:
     ...
     */
    Event(const char *type) : _type(type) { assert(type); }
    /**
     * @returns Event type
     */
  ...
  public:
    /**
     * @brief Callback function to be called when event is dispatched to this subscriber
     */
